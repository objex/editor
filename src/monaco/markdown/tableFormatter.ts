import {CancellationToken, editor, languages, Thenable} from "monaco-editor";
...
export class MarkdownDocumentFormatter implements languages.DocumentFormattingEditProvider {
