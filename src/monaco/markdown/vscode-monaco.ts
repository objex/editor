...
function revealRangeInEditor(_editor: editor.ICodeEditor, range: IRange, revealType: TextEditorRevealType): void {
    switch (revealType) {
        ...
        case undefined:
            _editor.revealRange(range, 0); // editor.ScrollType.Smooth
            break;
        case TextEditorRevealType.InCenter:
            _editor.revealRangeInCenter(range, 0); // editor.ScrollType.Smooth
            break;
        case TextEditorRevealType.InCenterIfOutsideViewport:
            _editor.revealRangeInCenterIfOutsideViewport(range, 0); // editor.ScrollType.Smooth
            break;
        case TextEditorRevealType.AtTop:
            _editor.revealRangeAtTop(range, 0); // editor.ScrollType.Smooth
            break;
        default:
