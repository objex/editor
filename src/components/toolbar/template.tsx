...
function executeAction(actionId: string) {
  return async () => {
    if (window.editor) {
      if (actionId === 'insertLink') {
        window.editor.trigger('keyboard', 'type', {text: "[Link Title]()"});
      } else if (actionId === 'insertImage') {
        window.editor.trigger('keyboard', 'type', {text: "![Alt Text]()"});
      }

      let action = window.editor.getAction('markdown.extension.editing.' + actionId);
      if (action) {
        await action.run();
      }
    }
...
export function renderToolbar() {
  return (
    <div class="flex item-center p-1.5 bg-gray-100 space-x-1.5">
      ...
      <button x-on:click={executeAction('toggleItalic')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">
        <svg class="h-5 w-5" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2"
             stroke-linecap="round" stroke-linejoin="round">
          <path d="M9.167 4.167h5M5.833 15.833h5M11.667 4.167L8.333 15.833"/>
        </svg>
      </button>
      <button x-on:click={executeAction('toggleStrikethrough')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">
        <svg class="h-5 w-5" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2"
             stroke-linecap="round" stroke-linejoin="round">
      ...
      <button x-on:click={executeAction('toggleHeading1')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">
      ...
      <button x-on:click={executeAction('toggleHeading2')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">
        <svg class="h-5 w-5" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7"
             stroke-linecap="round" stroke-linejoin="round">
      ...
      <button x-on:click={executeAction('toggleHeading3')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">
        <svg class="h-5 w-5" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7"
             stroke-linecap="round" stroke-linejoin="round">
      ...
      <button x-on:click={executeAction('toggleHeading4')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">
        <svg class="h-5 w-5" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7"
             stroke-linecap="round" stroke-linejoin="round">
      ...
      <button x-on:click={executeAction('toggleUnorderedList')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">
      ...
      {/*<button x-on:click={actionHandler('orderedList')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">*/}
      {/*  <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">*/}
      ...
      {/*  </svg>*/}
      {/*</button>*/}
      <button x-on:click={executeAction('toggleBlockQuote')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">
        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
      ...
      <button x-on:click={executeAction('insertLink')} class="p-1 rounded text-gray-500 hover:bg-gray-200 transition duration-100">
